...
NighttimeSiege::NighttimeSiege(GameTime& gameTime, SunLight* sunlight) : Levels(5, gameTime, sunlight) {
	...
	background.loadFromFile("C:/Users/wajiz.pk/Desktop/sfml projects/SFML/Images/nightbackground.png");
	s_background.setTexture(background);
	s_background.setPosition(0, 0);
}
void NighttimeSiege::drawIcons(sf::RenderWindow& window) {
...
void NighttimeSiege::drawBackground(sf::RenderWindow& window) {
	window.draw(s_background);
}
int NighttimeSiege::getPlantType(Mouse mouse, sf::RenderWindow& window) {
	int plantChosen = -1;
...
void NighttimeSiege::zombiesCreation() {
